...
public class Expenses extends Transaction{
    ...
    /**
     * Constructor to initialize Expense object with budgetName, name, transaction type, frequency, and amount.
     * Pre: Expects five strings.
     * Post: Initialize an object.
     * @param budgetName
     * @param name
     * @param type
     * @param frequency
     * @param amount 
     */
    public Expenses(String budgetName,String name, String type,String frequency, String amount) {
     ...
     * Post: Return the real expense in double data type.
    ...
    public double calculateRealAmount(){
        ...
        double realExpense = originalAmount;
        
        //Multiply the original amount based on the frequency.
        if (frequency.equals("One Time")){
            realExpense = originalAmount;
        }else if (frequency.equals("Semi-Annual")){
            realExpense = originalAmount*2;
        }else if (frequency.equals("Quarterly")){
            realExpense = originalAmount*4;
        }else if (frequency.equals("Monthly")){
            realExpense = originalAmount*12;
        }else if (frequency.equals("Weekly")){
            realExpense = originalAmount*52;
        }else if (frequency.equals("Bi-Weekly")){
            realExpense = originalAmount*26;
        }else if (frequency.equals("Daily")){
            realExpense = originalAmount*365;
        }
        
        return realExpense;  //Return value
    ...
    /**
     * Pre: Expects a string.
     * Post: Set the value of expense name as the parameter value, does not return.
     * @param name 
     */
    @Override
    ...
    public String toString() {
        ...
        expenseData += budgetName+","+"expense"+","+name+","+type+","+frequency+","+amount;
        
        return expenseData; //Return string.
    }
